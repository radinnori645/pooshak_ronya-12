...
class ShippingAddress(models.Model):
    ...
    shipping_address1 = models.CharField(max_length=2000, blank=True)
    shipping_address2 = models.CharField(max_length=2000, blank=True, null=True)
    shipping_city = models.CharField(max_length=2000, blank=True)
    shipping_state = models.CharField(max_length=2000, blank=True)
    shipping_zipcode = models.CharField(max_length=2000, blank=True)
    shipping_country = models.CharField(max_length=2000, default= 'IRAN')
    class Meta:
        verbose_name_plural = 'ShippingAddress'

    def __str__(self):
        return f'Sipping Address Form {self.shipping_full_name}'
