...
def confim_order(request):
    if request.POST:
        ...
        return render(request, 'payment/confim_order.htm', {'cart_products': cart_products, 'quantities':quantities, 'total':total, 'shipping_info':user_shipping})

    else:
        messages.success(request, 'دسترسی به این صفحه امکان پذیر نمی  باشد')
        return redirect('home')
    # return render(request, 'payment/confim_order.htm', {})
